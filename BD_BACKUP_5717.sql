...
USE ROExpress 
IF OBJECT_ID('Bilet_Tren','U') IS NOT NULL DROP TABLE Bilet_Tren 
CREATE TABLE Bilet_Tren( 
	 ID_Bilet_Tren int IDENTITY(1,1) PRIMARY KEY, 
	 ID_Tren int foreign key references Trenuri(ID_Tren), 
	 Email varchar(50) not null, 
	 NumarVagon int not null, 
	 LocVagon int not null, 
	 Clasa int Not null,
	 DataTren date not null
)
